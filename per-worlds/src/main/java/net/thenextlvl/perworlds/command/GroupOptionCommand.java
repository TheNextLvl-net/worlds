...
class GroupOptionCommand {
    public static ArgumentBuilder<CommandSourceStack, ?> create(SharedWorlds commons) {
        return Commands.literal("option")
                ...
                .then(option("advancementMessages", GroupSettings::advancementMessages, GroupSettings::advancementMessages, commons))
                ...
                .then(option("deathMessages", GroupSettings::deathMessages, GroupSettings::deathMessages, commons))
                ...
                .then(option("joinMessages", GroupSettings::joinMessages, GroupSettings::joinMessages, commons))
                ...
                .then(option("quitMessages", GroupSettings::quitMessages, GroupSettings::quitMessages, commons))
